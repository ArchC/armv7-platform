...
class uart_module : public sc_module, public peripheral {
 private:
  ...
  enum wordsize_t {WS_7BIT=0, WS_8BIT=1};
  enum dtr_edge_t {D_RISING=0, D_FALLING_1, D_BOTH=2};
  enum ref_freq_t {RF_DIVBY6=0, RF_DIVBY5=1, RF_DIVBY4=2, RF_DIVBY3=3, RF_DIVBY2=4,
